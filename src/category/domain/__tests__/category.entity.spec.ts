...
describe("Category Unit Tests", () => {
	...
	let validateSpy: any;
	beforeEach(() => {
		// resetar o testes do Mock a cada teste
		validateSpy = jest.spyOn(Category, "validate");
	});

	describe("constructor", () => {
		test("shoud create a category only name", () => {
			// TDD
			// Triple AAA
			// Dividir o teste em Arrange (Input de dados), Act (Movientação ou processamento) e Assert (se o que foi processado está de fato com o que eu espero)
		...
		test("shoud create a category with all values", () => {
		...
		test("shoud create a category only name and description", () => {
			const category = new Category({
				name: "Movie",
				description: "Movie description"
			});
...
describe("Category Validator", () => {
	describe("create command", () => {
		test("shoud an invalid category with name property", () => {
