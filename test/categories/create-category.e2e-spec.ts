...
import { ICategoryRepository } from '../../src/core/category/domain/category.respository';
    ...
    describe('should create a category', () => {
      ...
      test.each(arrange)(
        ...
        async ({ send_data, expected }) => {
          ...
          const serialized = instanceToPlain(presenter); // cria uma instância do objeto JS
